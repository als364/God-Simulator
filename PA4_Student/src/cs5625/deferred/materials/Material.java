...
public abstract class Material implements OpenGLResourceObject
{
	...
	public void setLights(ArrayList<Light> l) {
		lights = l;
	...
	/**
	 * True if this material is opaque and can be shaded using deferred shading.
	 * False if it must be rendered in the forward shading pass.
	 */
